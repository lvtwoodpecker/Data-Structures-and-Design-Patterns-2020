...
//  This is an exercise for the Data Structures class. Creating a doubly linked list class with multiple functionalities. Main file
...
do{
    try myList.insertAt(index: 6, element: 11)
} catch let error {
    print("Error: \(error)")
}
